...
<div class="container bootstrap snipets">
    <h1 class="text-center text-muted">Galeria de productos</h1>
    <div class="row flow-offset-1">
        @foreach ($datos as $item)

        <div class="col-xs-6 col-md-4">
            <div class="product tumbnail thumbnail-3"><a> <img class="img-fluid" src="{{ asset('storage').'/'.$item->imagen}}" alt="foto" style="href:200px; height:200px;" ></a>
            <div class="caption">
